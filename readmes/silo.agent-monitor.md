...
![The Agents view in the Navigator, showing Ready and Working sections across workspaces](https://raw.githubusercontent.com/silo-code/silo-extensions/agent-monitor@v0.2.7/agent-monitor/assets/agents-panel.png)
![Workspaces panel showing agent status rows for running Claude Code sessions](https://raw.githubusercontent.com/silo-code/silo-extensions/agent-monitor@v0.2.7/agent-monitor/assets/screenshot.png)
